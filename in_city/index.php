...
$APPLICATION->SetPageProperty("description", "Crado - ваш гид по активному отдыху в городе. Лучшие места и события в горде Сургуте. Выберите лучший городской отдых.");
$APPLICATION->SetPageProperty("title", "Crado | Отдых в городе Сургут на портале активного отдыха");
...
<div class="bgray-light">
    <div class="container">
        ...
        <div class="category row">
            <?include_once $_SERVER['DOCUMENT_ROOT']."/include/categories.php";?>
        </div>
        <div class="pad_20_0 small-block">
            <?include_once $_SERVER['DOCUMENT_ROOT']."/include/in_city_material.php";?>
        </div>
		<div class="pad_25_0">
							<div class="text-center"><h2>Все спортивные секции в городе Сургут</h2></div><br/>
							<div class="category row">
								<div class="row line">
								<? $a=0;?>
        ...
        <div class="pad_50_0 text-center">
            Crado - ваш гид по активному отдыху в городе. Лучшие места и события в горде Сургуте. Выберите лучший городской отдых.
        </div>
    </div>
</div>
