...
<?
   // echo 'Материал на главной отсортированный по дате с метками';
	...
	$baner_city = baner_city('out_city_link');						
    ...
    $count_element = count_element_out_city(2);
    
    //echo $count_element;
    
    $mater = material_outcity($page_size,$page);
    ...
    <div class="small-list">
        ...
        <?if($page*$page_size <= $count_element-1):?>    
                <div class="text-center more">
                    <a href="?page=<?=$page+1?>" data-page="<?=$page+1?>" onclick="outcity_next(event,this,<?=$page+1?>)"class="button">Показать ещё</a>
