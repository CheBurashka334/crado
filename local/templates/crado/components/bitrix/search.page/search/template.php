        ...
        */?>
        ...
        <?elseif(count($arResult["SEARCH"])>0):?>
			...
			<div class="result-search">
                            По запросу <b>"<?=$_GET['q']?>"</b> найдено <?=$arResult['NAV_RESULT']->NavRecordCount?>
			</div>
			<div class="data_home" id="search-material">
        	...
        	<?endforeach;?>
                    ...
                    <?if($arResult['NAV_RESULT']->NavPageNomer < $arResult['NAV_RESULT']->NavPageCount):?>
                        <div class="text-center more">
                            <a href="?page=2" data-page="2" onclick='search_next(event,this,"<?=$_GET['q']?>","2")' class="button">Показать ещё</a>
