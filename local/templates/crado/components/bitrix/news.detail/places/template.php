                    ...
                    <div class="dop-znachenia">
                        <?for($a=0;$a<count($arResult['PROPERTIES']['dop_znachenia']['VALUE']); $a++){?>
                            <div class="item">
                                ...
                                <div>
                                <?if($arResult['PROPERTIES']['dop_znachenia']['DESCRIPTION'][$a] == 'Сайт' || $arResult['PROPERTIES']['dop_znachenia']['DESCRIPTION'][$a] == 'Вконтакте' || $arResult['PROPERTIES']['dop_znachenia']['DESCRIPTION'][$a] == 'Facebook'):?>
                                    <?
                                        
                                        $link = $arResult['PROPERTIES']['dop_znachenia']['~VALUE'][$a];
                                        if(strripos($link, 'http://') !== false)
                                            $link = str_replace('http://',"",$link);
                                        if(strripos($link, 'https://') !== false)
                                            $link = str_replace('https://',"",$link);
                                            
                                    ?>
                                    <a href="http://<?=$link;?>" target="_blank" rel="nofollow">http://<?=$link;?></a>
                                <?else:?>
                                    <?=$arResult['PROPERTIES']['dop_znachenia']['VALUE'][$a];?>
                                <?endif;?>
                                </div>
                            </div>
                        <?}?>
    ...
    <div class="container">
        <div class="left">
			...
			<div class="dop-text like">
				<?
					$description = str_replace(array("\r\n", "\r", "\n","\"","<b>","</b>"), '',  "".strip_tags(html_security($arResult["PREVIEW_TEXT"]))."");	
