...
<div class="bgray-light">
    <div class="container">
        ...
        <div class="pad_40_0">
            ...
            <div class="search">
                                <input type="text" id="ajax-search" onkeypress="if (event.keyCode == 13) ajaxsearch_shops()" placeholder="Быстрый поиск"/>
                                <input type="submit" id="ajax-search-button" onclick="ajaxsearch_shops()" value="Искать"/>
                        </div>
                            <?
                                $iblok_id = '2';
